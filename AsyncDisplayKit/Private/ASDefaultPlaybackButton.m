...
{
  ASDefaultPlaybackButtonType buttonType = ASDefaultPlaybackButtonTypePlay;//[parameters[@"buttonType"] intValue];
  UIColor *color = [UIColor whiteColor];//parameters[@"color"];
